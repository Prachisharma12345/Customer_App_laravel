...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if(isset($_POST['special-price_sale_submit'])){
                        ...
                        <div class="text-center">
                            ...
                            <form method="post">
                                ...
                                if(in_array($item['item_id'],$in_cart??[])){
                                    echo ' <button type="submit" disabled name="special-price_sale_submit" class="btn btn-success font-size-12">In the Cart</button>';
                                }
                                else{
                                    echo ' <button type="submit" name="special-price_sale_submit" class="btn btn-warning font-size-12">Add to Cart</button>';
                                }
                                ?>
